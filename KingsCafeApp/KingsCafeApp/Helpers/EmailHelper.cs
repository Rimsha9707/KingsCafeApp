    ...
    public class EmailHelper
    {
        public string EmailSender(string Email, string Subject, string Message)
        {
            try
            {
                ...
                mail.To.Add(Email);
                mail.From = new MailAddress("ayaz9707@gmail.com", Subject, System.Text.Encoding.UTF8);
                ...
                client.Credentials = new System.Net.NetworkCredential("ayaz9707@gmail.com", "gowpepdglcafxdrw");
